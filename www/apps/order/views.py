...
from goods.models import GoodsskuClassModel
from order.models import Transport, Order, OrderGoods
from users.models import UserAddress


class MakeOrderView(VerifyLoginView):
    '''确认订单'''
    def get(self,request):
        ...
        for sku_id in sku_ids:
            # 商品信息
            try:
                goods_sku = GoodsskuClassModel.objects.get(pk=sku_id)
            ...
            # 统计商品总计
            goods_total_price += goods_sku.goodsprice * count
